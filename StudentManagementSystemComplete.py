def addstudent():
    ...
    addroot.iconbitmap('mana.ico.png')
...
def searchstudent():
    ...
    searchroot.iconbitmap('mana.ico.png')
...
def updatestudent():
    ...
    updateroot.iconbitmap('mana.ico.png')
...
def Connectdb():
    def submitdb():
        ...
        try:
            ...
            return
        try:
            strr = 'create database studentmanagementsystemp'
            mycursor.execute(strr)
            strr = 'use studentmanagementsystemp'
            mycursor.execute(strr)
    ...
    dbroot.iconbitmap('mana.ico.png')
...
searchbtn = Button(DataEntryFrame,text='2.  Seach Student',width=25,font=('chiller',20,'bold'),bd=6,bg='skyblue3',activebackground='blue',relief=RIDGE,
